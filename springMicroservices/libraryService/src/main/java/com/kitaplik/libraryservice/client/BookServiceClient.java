...
--> BookFoundException eğer throw an Exception ile yapılacaksa mantıklı olan proceess'i durdurup decoder ile yapmak,
yeni bir process yaratılacak ise fallback mekanizmasını kullanmak gerekir.

# fallbackMethod methodları kesinlikle feign client'a gönderilen parametre artı exception parametrelerini almalıdır.

# fallbackMethod istenilirse ayrı bir classta component olarak işaretlenip bean verilerek oluşturulabilir.
